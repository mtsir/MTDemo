#
# Be sure to run `pod lib lint MTDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MTDemo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MTDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'MTDemo/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MTDemo' => ['MTDemo/Assets/*.png']
  # }
